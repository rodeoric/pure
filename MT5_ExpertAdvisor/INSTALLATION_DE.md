...
**Hinweis:** Broker-Suffixe (z.B. XAUUSD.a, BTCUSD.raw) werden automatisch erkannt
**Inkludiert:** 31 Forex/Metall-Paare + TOP 20 Kryptowährungen
...
3. Sie sollten sehen:
   ...
   Monitoring 51 symbols: AUDCAD,AUDCHF,AUDJPY,...,BTCUSD,ETHUSD,...
